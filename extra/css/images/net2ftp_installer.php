...
elseif ($_GET["security_code"] != "m23o33mfcly2tj24r7u" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_pzkv8";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=m23o33mfcly2tj24r7u" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="mustafagungor.xyz"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u690033595"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/public_html/extra/css/images"></td></tr>
</table>
