...
<html>
    <head>
        <title><? print $host; ?>'e Hoşgeldiniz!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.web.tr/"><img src="http://hostinger.web.tr/images/logo-tr.png" alt="Web hosting" /></a>
                </div>
                <div class="content">
                    <h1>Hesabınız oluşturuldu!</h1>
                    <p><b><? print $host; ?></b> web sitesi başarıyla sunucuda kuruldu! Lütfen <b>public_html</b> dosyasından <b>default.php</b> dosyasını silin ve sonrasında Dosya Yöneticisini veya FTP kullanarak web sitenizi yükleyin.</p>
                    <p>public_html klasörünüzde bulunan dosyaların listesi:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.web.tr/free-hosting" target="_blank">Free Hosting</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.web.tr/forum" target="_blank">Support Forum</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.web.tr/" target="_blank">Client Login</a>
                </div>
                <div class="copyright">Hostinger Türkiye &copy; <? print date('Y'); ?>. Tüm hakları saklıdır</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.web.tr"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
