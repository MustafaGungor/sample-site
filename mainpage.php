...
<div class="container">
      ...
      <div class="blog-header">
		...
		include("page/baslik.php");
		//echo "<b><i>".$gelen."</i></b>";
		
		
		
		?></h1><!--gelen get değeri başlık konusu olarak atandı -->
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main ">
          ...
          <?php 
				...
				while($oku=mysqli_fetch_assoc($sorgu)){
				 ...
				 echo "<a  href='konu.php?isim=".$oku['blog_title']."'><h4><img src='img/message2.png' width='50' height='40'>&nbsp;&nbsp;".$oku['blog_title']."</h4></a>";

				 echo '<h4 align="right">('.$oku["blog_date"].')</h4></div></div>';
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          ...
          <div class="sidebar-module">
            ...
            <?php include("page/menu_cek.php"); ?><!--menu_cek.php den ana başlıklar çekildi -->
